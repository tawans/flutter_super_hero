...
/// @nodoc
mixin _$HomeState {
  List<SuperHero> get heros => throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<SuperHero> heros, bool isLoading, bool isSearching});
}
...
class _$_HomeState with DiagnosticableTreeMixin implements _HomeState {
  const _$_HomeState(
      {final List<SuperHero> heros = const [],
